...
o = LopheliaLarvaeDrift(loglevel=0, logfile="test_lophelia_SVIM_MLD_agg_01.log")
...
# Output file name:
outname = 'seedingBeryl_tempdepdev1_tempdepws1_MLD_SVIM_agg_15d_20120201_test01.nc'
